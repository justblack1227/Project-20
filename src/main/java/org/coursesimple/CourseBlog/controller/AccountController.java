...
import org.coursesimple.CourseBlog.services.EmailService;
import org.coursesimple.CourseBlog.util.AppUtil;
import org.coursesimple.CourseBlog.util.email.EmailDetails;
...
public class AccountController {
    ...
    public String reset_password(@RequestParam("email") String _email, RedirectAttributes attributes, Model model) {
        ...
        if (optional_account.isPresent()) {
            ...
            EmailDetails emailDetails = new EmailDetails(account.getEmail(), reset_message, "Reset password CourseSimple demo");
